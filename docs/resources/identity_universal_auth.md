...
page_title: "kms_identity_universal_auth Resource - terraform-provider"
subcategory: "Identities"
description: |-
  Create and manage identity universal auth in Hanzo KMS.
---

# kms_identity_universal_auth (Resource)
