...
page_title: "kms_project_user Resource - terraform-provider"
subcategory: "Projects"
description: |-
  Create project users & save to Hanzo KMS. Only Machine Identity authentication is supported for this resource
---

# kms_project_user (Resource)
