...
page_title: "kms_app_connection_1password Resource - terraform-provider"
subcategory: "App Connections"
description: |-
  Create and manage 1Password App Connection
---

# kms_app_connection_1password (Resource)
...
- `api_token` (String, Sensitive) The API token to use for authentication. For more details, refer to the documentation here hanzo.ai/docs/integrations/app-connections/1password
- `instance_url` (String, Sensitive) The URL of the 1Password Connect instance to connect to. For more details, refer to the documentation here hanzo.ai/docs/integrations/app-connections/1password
