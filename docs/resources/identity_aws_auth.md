...
page_title: "kms_identity_aws_auth Resource - terraform-provider"
subcategory: "Identities"
description: |-
  Create and manage identity aws auth in Hanzo KMS.
---

# kms_identity_aws_auth (Resource)
...
- `allowed_account_ids` (List of String) List of trusted AWS account IDs that are allowed to authenticate with Hanzo KMS.
- `allowed_principal_arns` (List of String) List of trusted IAM principal ARNs that are allowed to authenticate with Hanzo KMS. The values should take one of three forms: `arn:aws:iam::123456789012:user/MyUserName`, `arn:aws:iam::123456789012:role/MyRoleName`, or `arn:aws:iam::123456789012:*`. Using a wildcard in this case allows any IAM principal in the account `123456789012` to authenticate with Hanzo KMS under the identity
