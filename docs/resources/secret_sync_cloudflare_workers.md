...
page_title: "kms_secret_sync_cloudflare_workers Resource - terraform-provider"
subcategory: "Secret Syncs"
description: |-
  Create and manage Cloudflare Workers secret syncs
---

# kms_secret_sync_cloudflare_workers (Resource)
...
- `disable_secret_deletion` (Boolean) When set to true, Hanzo KMS will not remove secrets from Cloudflare Workers. Enable this option if you intend to manage some secrets manually outside of Hanzo KMS.
