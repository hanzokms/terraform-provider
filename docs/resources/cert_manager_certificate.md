...
page_title: "kms_cert_manager_certificate Resource - terraform-provider"
subcategory: "Certificate Management"
description: |-
  Request and manage certificates from Hanzo KMS certificate profiles. Supports both CSR-based and direct field requests. The resource will poll until the certificate is issued or a timeout is reached. Only Machine Identity authentication is supported for this resource.
---

# kms_cert_manager_certificate (Resource)
