...
page_title: "kms_project_template Resource - terraform-provider"
subcategory: "Projects"
description: |-
  Create project templates & save to Hanzo KMS. Only Machine Identity authentication is supported for this resource.
---

# kms_project_template (Resource)
...
- `type` (String) The type of the project template. Refer to the documentation here https://hanzo.ai/docs/api-reference/endpoints/project-templates/create#body-type for the available options
...
- `permissions` (Attributes List) The permissions assigned to the role. Refer to the documentation here https://hanzo.ai/docs/api-reference/endpoints/project-templates/create#body-roles-permissions for its usage. (see [below for nested schema](#nestedatt--roles--permissions))
