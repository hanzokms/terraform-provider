...
page_title: "kms_cert_manager_ca_certificate Resource - terraform-provider"
subcategory: "Certificate Management"
description: |-
  Create and manage CA certificates in Hanzo KMS. Only Machine Identity authentication is supported for this resource.
---

# kms_cert_manager_ca_certificate (Resource)
