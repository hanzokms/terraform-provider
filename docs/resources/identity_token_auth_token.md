...
page_title: "kms_identity_token_auth_token Resource - terraform-provider"
subcategory: "Identities"
description: |-
  Create and manage identity token auth token in Hanzo KMS.
---

# kms_identity_token_auth_token (Resource)
