...
page_title: "kms_cert_manager_external_ca_acme Resource - terraform-provider"
subcategory: "Certificate Management"
description: |-
  Create and manage external ACME certificate authorities in Hanzo KMS. Only Machine Identity authentication is supported for this resource.
---

# kms_cert_manager_external_ca_acme (Resource)
