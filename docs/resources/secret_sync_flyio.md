...
page_title: "kms_secret_sync_flyio Resource - terraform-provider"
subcategory: "Secret Syncs"
description: |-
  Create and manage Fly.io secret syncs
---

# kms_secret_sync_flyio (Resource)
...
- `disable_secret_deletion` (Boolean) When set to true, Hanzo KMS will not remove secrets from Fly.io. Enable this option if you intend to manage some secrets manually outside of Hanzo KMS.
