...
page_title: "kms_secret_import Resource - terraform-provider"
subcategory: "Secrets"
description: |-
  Create secret import & save to Hanzo KMS.
---

# kms_secret_import (Resource)
...
- `project_id` (String) The Hanzo KMS project ID
