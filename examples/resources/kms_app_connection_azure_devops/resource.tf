...
resource "kms_app_connection_azure_devops" "app_connection_azure_devops_client_secret" {
...
resource "kms_app_connection_azure_devops" "app_connection_azure_devops_access_token" {
