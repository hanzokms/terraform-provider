...
page_title: "kms_secret_sync_azure_key_vault Resource - terraform-provider"
subcategory: "Secret Syncs"
description: |-
  Create and manage Azure Key Vault secret syncs
---

# kms_secret_sync_azure_key_vault (Resource)
...
- `disable_secret_deletion` (Boolean) When set to true, Hanzo KMS will not remove secrets from Azure Key Vault. Enable this option if you intend to manage some secrets manually outside of Hanzo KMS.
