...
page_title: "kms_secret_sync_cloudflare_pages Resource - terraform-provider"
subcategory: "Secret Syncs"
description: |-
  Create and manage Cloudflare Pages secret syncs
---

# kms_secret_sync_cloudflare_pages (Resource)
...
- `disable_secret_deletion` (Boolean) When set to true, Hanzo KMS will not remove secrets from Cloudflare Pages. Enable this option if you intend to manage some secrets manually outside of Hanzo KMS.
