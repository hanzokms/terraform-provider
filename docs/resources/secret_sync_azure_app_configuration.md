...
page_title: "kms_secret_sync_azure_app_configuration Resource - terraform-provider"
subcategory: "Secret Syncs"
description: |-
  Create and manage Azure App Configuration secret syncs
---

# kms_secret_sync_azure_app_configuration (Resource)
...
- `disable_secret_deletion` (Boolean) When set to true, Hanzo KMS will not remove secrets from Azure App Configuration. Enable this option if you intend to manage some secrets manually outside of Hanzo KMS.
