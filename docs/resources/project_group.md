...
page_title: "kms_project_group Resource - terraform-provider"
subcategory: "Projects"
description: |-
  Create project groups & save to Hanzo KMS. Only Machine Identity authentication is supported for this data source
---

# kms_project_group (Resource)
