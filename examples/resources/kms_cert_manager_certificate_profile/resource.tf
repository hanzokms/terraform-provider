...
resource "kms_cert_manager_certificate_policy" "web_server" {
  project_slug = kms_project.pki.slug
...
resource "kms_cert_manager_certificate_profile" "web_server_api" {
  project_slug          = kms_project.pki.slug
  ca_id                 = kms_cert_manager_internal_ca.issuing.id
  certificate_policy_id = kms_cert_manager_certificate_policy.web_server.id
...
resource "kms_cert_manager_certificate_profile" "web_server_est" {
  project_slug          = kms_project.pki.slug
  ca_id                 = kms_cert_manager_internal_ca.issuing.id
  certificate_policy_id = kms_cert_manager_certificate_policy.web_server.id
...
resource "kms_cert_manager_certificate_profile" "self_signed_dev" {
  project_slug          = kms_project.pki.slug
  certificate_policy_id = kms_cert_manager_certificate_policy.web_server.id
...
# ACME profile
resource "kms_cert_manager_certificate_profile" "acme_profile" {
  project_slug          = kms_project.pki.slug
...
resource "kms_cert_manager_certificate_profile" "adcs_profile" {
  project_slug          = kms_project.pki.slug
