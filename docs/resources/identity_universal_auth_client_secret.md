...
page_title: "kms_identity_universal_auth_client_secret Resource - terraform-provider"
subcategory: "Identities"
description: |-
  Create and manage identity universal auth client secret in Hanzo KMS.
---

# kms_identity_universal_auth_client_secret (Resource)
