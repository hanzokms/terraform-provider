...
page_title: "kms_secret_sync_gcp_secret_manager Resource - terraform-provider"
subcategory: "Secret Syncs"
description: |-
  Create and manage GCP Secret Manager secret syncs
---

# kms_secret_sync_gcp_secret_manager (Resource)
...
- `disable_secret_deletion` (Boolean) When set to true, Hanzo KMS will not remove secrets from GCP Secret Manager. Enable this option if you intend to manage some secrets manually outside of Hanzo KMS.
