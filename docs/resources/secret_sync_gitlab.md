...
page_title: "kms_secret_sync_gitlab Resource - terraform-provider"
subcategory: "Secret Syncs"
description: |-
  Create and manage GitLab secret syncs
---

# kms_secret_sync_gitlab (Resource)
...
- `disable_secret_deletion` (Boolean) When set to true, Hanzo KMS will not remove secrets from GitLab. Enable this option if you intend to manage some secrets manually outside of Hanzo KMS.
