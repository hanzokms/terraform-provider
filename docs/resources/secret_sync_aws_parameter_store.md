...
page_title: "kms_secret_sync_aws_parameter_store Resource - terraform-provider"
subcategory: "Secret Syncs"
description: |-
  Create and manage AWS Parameter Store secret syncs
---

# kms_secret_sync_aws_parameter_store (Resource)
...
- `disable_secret_deletion` (Boolean) When set to true, Hanzo KMS will not remove secrets from AWS Parameter Store. Enable this option if you intend to manage some secrets manually outside of Hanzo KMS.
