...
page_title: "kms_cert_manager_certificate_profile Resource - terraform-provider"
subcategory: "Certificate Management"
description: |-
  Create and manage certificate profiles in Hanzo KMS. Only Machine Identity authentication is supported for this resource.
---

# kms_cert_manager_certificate_profile (Resource)
