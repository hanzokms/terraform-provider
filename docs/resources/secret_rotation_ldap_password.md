...
page_title: "kms_secret_rotation_ldap_password Resource - terraform-provider"
subcategory: "Secret Rotations"
description: |-
  Create and manage LDAP Password Secret Rotations
---

# kms_secret_rotation_ldap_password (Resource)
...
- `project_id` (String) The ID of the Hanzo KMS project to create the secret rotation in.
